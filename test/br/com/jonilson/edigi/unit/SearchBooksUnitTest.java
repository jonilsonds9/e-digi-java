...
public class SearchBooksUnitTest {
    ...
    public void shouldShowBooks() {
        ...
        Mockito.when(bookDao.searchBooks("Apli")).thenReturn(new ArrayList<>(Arrays.asList(book1, book2)));
    ...
    public void NotShowBooksWithTitleWithLessThanTwoCharacters() {
        ...
        Mockito.when(bookDao.searchBooks("A"))
                .thenThrow(new IllegalArgumentException("O título precisa conter pelo menos 2 caracteres!"));
    ...
    public void shouldNotShowBooksIifNoneAreFound() {
        ...
        Mockito.when(bookDao.searchBooks("Testes automatizados"))
                .thenThrow(new IllegalArgumentException("Nenhum livro encontrado!"));
